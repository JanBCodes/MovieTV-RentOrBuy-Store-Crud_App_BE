...
//Postman Clean Up 
router.delete(`/movies/deleteTitle/:title`,  adminServices.deleteAllMoviesByTitle);
router.delete(`/tvShows/deleteTitle/:title`,  adminServices.deleteAllTVShowsByTitle);
